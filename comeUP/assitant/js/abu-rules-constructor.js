...
/**
 * abu rules constructor library
 */
var AdguardRulesConstructorLib = (function () { 
    ...
    var haveUrlBlockParameter = function (element) {
        ...
        console.log('haveUrlBlockParameter: ', value);
        return value && value !== '';
    };
    ...
    /**
     * Constructs abu rule text from element node and specified options
     *
     * var options = {
