...
var CssHitsCounter = (function () { 

    'use strict';

    var CONTENT_ATTR_PREFIX = 'abu';
     ...
     * 2. For each element from sub collection: retrieve calculated css 'content' attribute and if it contains 'abu' marker then retrieve rule text and filter identifier.
    ...
    function countCssHitsBatch(elements, start, end, step, result, callback) {
        ...
        for (var i = start; i < length; i++) {
            ...
            // Attribute 'content' in css looks like: {content: 'abu{filterId};{ruleText}'}
